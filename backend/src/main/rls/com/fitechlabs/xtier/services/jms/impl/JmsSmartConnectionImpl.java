...
class JmsSmartConnectionImpl
    implements JmsSmartConnection
{

    JmsSmartConnectionImpl(ConnectionFactory connectionfactory, String s, String s1, int i, long l)
        throws JMSException
    {
        helper = new JmsSmartConnectionHelper(connectionfactory, s, s1, i, l);
    }
