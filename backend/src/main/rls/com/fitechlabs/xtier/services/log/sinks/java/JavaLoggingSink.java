...
package com.fitechlabs.xtier.services.log.sinks.java;
...
public class JavaLoggingSink extends LogSinkAdapter
{

    public JavaLoggingSink(String s, LogFilter logfilter, LogErrorHandler logerrorhandler)
    {
        super(s, null, logfilter, logerrorhandler);
    }

    public JavaLoggingSink(String s)
    {
        this(s, null, null);
    }
    ...
    public void add(LogRecord logrecord)
    {
        synchronized(getMutex())
        {
            ...
            try
            {
                ...
                {
                    Level level = logLevel2java(logrecord.getLevel());
    ...
    private Level logLevel2java(int i)
    {
        switch(i)
        {
        case 64: // '@'
    ...
    {
        return L10n.format("SRVC.LOG.JSINK.TXT1", getName(), getFilter(), getErrorHandler());
    }
    ...
    static
    {
        $assertionsDisabled = !(JavaLoggingSink.class).desiredAssertionStatus();
    }
}
